...
local function SetSliderMechanics(slider, value, minimum, maximum, increment,dontshowperc)
...
TidyPlatesHubRapidPanel.CreateQuickSliderNoPercent = CreateQuickSliderNoPercent
