...
-- local CreateQuickSliderNoPercent = TidyPlatesHubRapidPanel.CreateQuickSliderNoPercent
...
local function CreateQuickSliderNoPercent(name,label,...)
	local columnFrame = ...
	local frame = PanelHelpers:CreateSliderFrame(name, columnFrame, label, .5, 10, 40, 1, "ACTUAL")
	frame:SetWidth(170)
	-- Margins	-- Bottom/Left are negative
	frame.Margins = {Left = 12, Right = 8, Top = 20, Bottom = 13}
	QuickSetPoints(frame, ...)
...
local function CreateInterfacePanel(panelName, panelTitle, heading, parentTitle)
	...
	panel.WidgetsTotemIconSize = CreateQuickSliderNoPercent(panelName .. "WidgetsTotemIconSize", L["Show Totem Icons Size"], AlignmentColumn, panel.WidgetsTotemIcon, 0, 2)

	panel.WidgetsComboPoints = CreateQuickCheckbutton(panelName .. "WidgetsComboPoints", L["Show Combo Points"], AlignmentColumn, panel.WidgetsTotemIconSize)
	...
	SetSliderMechanics(panel.WidgetsTotemIconSize,10,10,60,1)
